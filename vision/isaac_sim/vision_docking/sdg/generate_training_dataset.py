...
# For this project scene, the first-person camera was already checked:
# camera optical axis ~= +X on the ground plane
# camera right        ~= -Y on the ground plane
#
# Use a fixed basis by default to avoid transform-convention ambiguity.
